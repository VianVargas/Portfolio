  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`absolute -top-32 -left-32 w-[550px] h-[550px] rounded-full blur-[50px] z-0 transition-opacity duration-500 ${
      ...
      <motion.div
        ...
        className={`absolute top-1/3 -right-32 w-[600px] h-[600px] rounded-full blur-[50px] z-0 transition-opacity duration-500 ${
      ...
      <motion.div
        ...
        className={`absolute -bottom-40 left-1/4 w-[650px] h-[650px] rounded-full blur-[60px] z-0 transition-opacity duration-500 ${
