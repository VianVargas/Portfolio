  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        >
          <div
            className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg border text-xs font-mono ${
              isLight
                ...
                >
                  <div className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                      <h3
                        className={`text-xl font-bold font-sans tracking-tight leading-snug ${
                          isLight ? "text-slate-900" : "text-white"
                        }`}
                      >
                        {cert.title}
